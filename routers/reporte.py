...
def costo_produccion(id):
    ...
    tcol_set(pdf, 'gray')
    pdf.cell(w=65, h=h_sep, txt='Peso: ' + str(data[4] + " Kg"), border=0, align='R', fill=0)
    
    tcol_set(pdf, 'gray')
    pdf.cell(w=35, h=h_sep, txt='Tipo ingreso: ', border=0, align='R', fill=0)

    tcol_set(pdf, 'black')
    pdf.multi_cell(w=0, h=h_sep, txt=str(data[8]), border=0, align='L', fill=0)
...
####################### informa de cerdos vendidos
    
#ver informa de cerdos vendidos
@reporte.route('/informa_cerdos_vendidos/<string:f_i>/<string:f_f>')
def informa_cerdos_vendidos(f_i, f_f):
    fecha = time.strftime('%Y-%m-%d', time.localtime())
    empresa = Empresa()
    ...
    class PDF(FPDF):
        ...
        def header(self):
            ...
            tfont_size(self, 35)
            tfont(self, 'B')
            self.cell(w=0, h=20, txt='     Informe de cerdos vendidos', border=0, ln=1, align='C', fill=0)
    ...
    data = Reportes.Informe_cerdos_vendidos(f_i, f_f) 
    ...
    pdf.cell(w=40, h=10, txt='Fecha', border=0, align='C', fill=1) 
    pdf.cell(w=40, h=10, txt='N° venta', border=0, align='C', fill=1) 
    pdf.cell(w=60, h=10, txt='Cerdo', border=0, align='C', fill=1)  
    pdf.cell(w=40, h=10, txt='Peso', border=0, align='C', fill=1) 
    ...
    for datos in data:
        ...
        pdf.cell(w=40, h=10, txt=str(datos[0]), border='TB', align='C', fill=1)   
        pdf.cell(w=40, h=10, txt=str(datos[1]), border='TB', align='C', fill=1)   
        pdf.cell(w=60, h=10, txt=str(datos[2]) + " - " + str(datos[3]), border='TB', align='C', fill=1)     
        pdf.cell(w=40, h=10, txt=str(datos[4]) + " Kg", border='TB', align='C', fill=1) 
        pdf.cell(w=40, h=10, txt="$. "+str(datos[5]), border='TB', align='C', fill=1) 
        pdf.multi_cell(w=0, h=10, txt="$. "+str(datos[6]), border='TBR', align='C', fill=1)
...
####################### FACTURA DE PEDIDOS DE CERDOS

@reporte.route('/pedidos_cerdos_factura/<int:id>')
def pedidos_cerdos_factura(id):
    fecha = time.strftime('%Y-%m-%d', time.localtime())
    empresa = Empresa()
    class PDF(FPDF):
        ...
        def header(self):
            ...
            tfont_size(self, 35)
            tfont(self, 'B')
            self.cell(w=0, h=20, txt='     Pedidos de cerdos', border=0, ln=1, align='C', fill=0)
    ...
    if data[11] == 0:              
        ...
        tfont_size(pdf, 15)
        tfont(pdf, 'B')
        pdf.multi_cell(w=0, h=10, txt='EL PEDIDO FUE ANULADO', border=0, align='C', fill=1)
        tfont(pdf, '')
    ...
    if data[11] == 2:              
        ...
        tfont_size(pdf, 15)
        tfont(pdf, 'B')
        pdf.multi_cell(w=0, h=10, txt='EL PEDIDO ESTA EN PROCESO', border=0, align='C', fill=1)
        tfont(pdf, '')

    bcol_set(pdf, 'green')
    tfont_size(pdf, 15)
    tfont(pdf, 'B')
    pdf.multi_cell(w=0, h=10, txt='Pedido', border=0, align='C', fill=1)
    tfont(pdf, '')
    ...
    tcol_set(pdf, 'black')
    pdf.multi_cell(w=0, h=h_sep, txt=str(data[12]), border=0, align='L', fill=0)
    ...
    tcol_set(pdf, 'black')
    pdf.cell(w=25, h=h_sep, txt=str(data[10]), border=0, align='L', fill=0)

    tcol_set(pdf, 'gray')
    pdf.cell(w=30, h=h_sep, txt='N° pedido:', border=0, align='R', fill=0)

    tcol_set(pdf, 'black')
    pdf.cell(w=20, h=h_sep, txt=str(data[1]), border=0, align='L', fill=0)

    tcol_set(pdf, 'gray')
    pdf.cell(w=30, h=h_sep, txt='Iva:', border=0, align='R', fill=0)
    ...
    tfont_size(pdf, 15)
    tfont(pdf, 'B')
    pdf.cell(w=0, h=10, txt='Cerdos pedidos', border=0, ln=1, align='C', fill=1)
    tfont(pdf, '')
    ...
    pdf.cell(w=25, h=10, txt="", border='TB', align='C', fill=1)   
    pdf.cell(w=30, h=10, txt="SubTotal: ", border='TB', align='C', fill=1)        
    pdf.multi_cell(w=0, h=10, txt="$ " + str(data[6]), border='TBR', align='C', fill=1)
...
####################### informa de pedidos de cerdos
    
#ver informa de pedidos de cerdos
@reporte.route('/informa_pedido_cerdos/<string:f_i>/<string:f_f>/<string:estado>')
def informa_pedido_cerdos(f_i, f_f, estado):
    fecha = time.strftime('%Y-%m-%d', time.localtime())
    empresa = Empresa()
    ...
    class PDF(FPDF):
        ...
        def header(self):
            ...
            tfont_size(self, 35)
            tfont(self, 'B')
            self.cell(w=0, h=20, txt='     Informe pedido de cerdos', border=0, ln=1, align='C', fill=0)
    ...
    pdf.cell(w=0, h=10, txt='Pedido de cerdos ' + estado, border=0, ln=1, align='C', fill=1)
    tfont(pdf, '')
    ...
    pdf.cell(w=15, h=10, txt='#', border=0, align='C', fill=1) 
    pdf.cell(w=40, h=10, txt='Fecha', border=0, align='C', fill=1) 
    pdf.cell(w=40, h=10, txt='N° pedido', border=0, align='C', fill=1) 
    pdf.cell(w=40, h=10, txt='Iva%', border=0, align='C', fill=1) 
    pdf.cell(w=50, h=10, txt='Subtotal', border=0, align='C', fill=1) 
    pdf.cell(w=60, h=10, txt='Impuesto', border=0, align='C', fill=1) 
    pdf.multi_cell(w=0, h=10, txt='Total', border=0, align='C', fill=1) 
    ...
    for datos in data:
        ...
        pdf.cell(w=15, h=10, txt=str(c), border='TBL', align='C', fill=1)   
        pdf.cell(w=40, h=10, txt=str(datos[6]), border='TB', align='C', fill=1)   
        pdf.cell(w=40, h=10, txt=str(datos[1]), border='TB', align='C', fill=1)   
        pdf.cell(w=40, h=10, txt=str(datos[5])+' %', border='TB', align='C', fill=1)                
...
####################### informa de cerdos pedidos
    
#ver informa de cerdos pedidos
@reporte.route('/informa_cerdos_pedidos/<string:f_i>/<string:f_f>/<string:estado>')
def informa_cerdos_pedidos(f_i, f_f, estado):
    fecha = time.strftime('%Y-%m-%d', time.localtime())
    empresa = Empresa()
    ...
    class PDF(FPDF):
        ...
        def header(self):
            ...
            tfont_size(self, 35)
            tfont(self, 'B')
            self.cell(w=0, h=20, txt='     Informe de cerdos pedidos', border=0, ln=1, align='C', fill=0)
    ...
    data = Reportes.Informe_cerdos_pedidos(f_i, f_f, estado) 
    ...
    tfont_size(pdf, 15)
    tfont(pdf, 'B')
    pdf.cell(w=0, h=10, txt='Cerdos pedidos ' + estado, border=0, ln=1, align='C', fill=1)
    tfont(pdf, '')
    ...
    for datos in data:
        ...
        pdf.cell(w=15, h=10, txt=str(c), border='TBL', align='C', fill=1)   
        pdf.cell(w=40, h=10, txt=str(datos[4]), border='TB', align='C', fill=1)   
        pdf.cell(w=40, h=10, txt=str(datos[5]), border='TB', align='C', fill=1)   
        pdf.cell(w=60, h=10, txt=str(datos[0]), border='TB', align='C', fill=1)     
        pdf.cell(w=40, h=10, txt=str(datos[1]) + " Kg", border='TB', align='C', fill=1) 
        pdf.cell(w=40, h=10, txt="$. "+str(datos[2]), border='TB', align='C', fill=1) 
        pdf.multi_cell(w=0, h=10, txt="$. "+str(datos[3]), border='TBR', align='C', fill=1)
